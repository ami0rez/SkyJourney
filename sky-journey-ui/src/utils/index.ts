import { FlightRequest, PassengerRequest } from "../services/nswag";
import {
  IErrorForm,
  IErrorMsg,
  IFlightListPages,
} from "../services/nswag/types";
...
export const validatePassengers = (
  ...
  champsErrorFirstName: string,
  champsErrorLastName: string,
  champsErrorEmail: string,
  champsErrorPhoneNumber: string
) => {
  ...
  for (let i = 0; i < passengers.length; i++) {
    ...
    if (!passenger.phoneNumber) {
      errors.phoneNumber = champsErrorPhoneNumber;
    }
