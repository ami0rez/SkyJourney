...
import { FlightRequest, FlightResponse } from "../services/nswag";
import { IErrorForm, IErrorMsg, IFlightListPages } from "../services/nswag/types";
...
describe("validatePassengers", () => {
  test("should return an empty array for valid passengers", () => {
    ...
    const champsErrorPhoneNumber = "Phone number is required";
